...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_EndGameHUDWidget_MetaData[];
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_EndGameHUDWidget;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AJobSimulatorGameModeBase_Statics::NewProp_EndGameHUDWidget_MetaData[] = {
		{ "Category", "Widget" },
		{ "Comment", "//widget class to use for our end screen\n" },
		{ "ModuleRelativePath", "JobSimulatorGameModeBase.h" },
		{ "ToolTip", "widget class to use for our end screen" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_AJobSimulatorGameModeBase_Statics::NewProp_EndGameHUDWidget = { "EndGameHUDWidget", nullptr, (EPropertyFlags)0x0024080000000001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AJobSimulatorGameModeBase, EndGameHUDWidget), Z_Construct_UClass_UUserWidget_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_AJobSimulatorGameModeBase_Statics::NewProp_EndGameHUDWidget_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AJobSimulatorGameModeBase_Statics::NewProp_EndGameHUDWidget_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AJobSimulatorGameModeBase_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AJobSimulatorGameModeBase_Statics::NewProp_EndGameHUDWidget,
	};
	...
	IMPLEMENT_CLASS(AJobSimulatorGameModeBase, 3723686760);
